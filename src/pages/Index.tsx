...
const Index = () => {
  return (
    <div className="flex flex-col min-h-screen">
      <section className="gradient-bg hero-pattern py-16 md:py-24 bg-gradient-to-br from-blue-50 to-white">
        <div className="container max-w-screen-xl">
          <div className="flex flex-col items-center text-center">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-querify-blue mb-6">
              Answer Your AI Automation Questions
            </h1>
            <p className="text-lg md:text-xl text-querify-blue/80 max-w-md mb-12">
              AIgentDesk provides expert answers to all your AI automation questions, helping you implement intelligent solutions.
            </p>
            
            <div className="text-2xl md:text-3xl font-semibold text-querify-blue/90 max-w-2xl mb-8 px-4 bg-blue-50/50 py-4 rounded-xl">
            ...
            <div className="w-full max-w-2xl mb-12">
              <div className="p-2 bg-blue-50/30 backdrop-blur rounded-xl shadow-lg border border-blue-100">
                <img 
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link to="/ask" className="w-full sm:w-auto">
                <Button className="bg-querify-blue text-white hover:bg-blue-700 text-lg px-10 py-7 w-full sm:w-auto">
                  Ask Your Questions
                </Button>
              </Link>
              <Link to="/about" className="w-full sm:w-auto">
                <Button variant="outline" className="border-querify-blue text-querify-blue hover:bg-blue-50 text-lg px-10 py-7 w-full sm:w-auto">
                  Learn More
                </Button>
              </Link>
            </div>
